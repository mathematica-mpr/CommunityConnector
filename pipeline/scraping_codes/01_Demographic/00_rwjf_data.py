...
for lkp in states:
    ...
    # none have a 3rd version
#     try:
#         file = file_template(state, "3")
#         data = pd.read_excel(file, 'Ranked Measure Data')
#         print(file)
#     except:
#         pass
...
#%% [markdown]
# # Other scraping tried

#%%
url = 'https://www.countyhealthrankings.org/app/ohio/2019/downloads'
u = urlopen(url)

try:
    html = gzip.decompress(u.read()).decode('utf-8')
finally:
    u.close()
