...
data_dictionary <- data_dictionary[!data_dictionary$column_name %in% remove_vars, ]
results_rm <- upd_implement_methodology(opts, outcomes, data, data_dictionary)
...
results[1][[1]] %>% 
  ...
  unique()
```
```{r Which variables did it keep instead of elevation?}
# Looks like alpha and lambda are the same or similar
coefs_df
