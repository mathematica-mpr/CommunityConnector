...
#data sets
sdohall <- read.csv("C:/Users/ECody/Desktop/AHRQProj/CommunityConnector/data-insights/final_data.csv")
dictionary <- read.csv("C:/Users/ECody/Desktop/AHRQProj/CommunityConnector/data-insights/final_data_dictionary.csv")
#removing score
dictionary <- dictionary[-(88:93),]
sdohall <- sdohall[-65,-(117:122)]
#dictionary <- read.csv("C:/Users/ECody/Desktop/data_dictionary_KC.csv")
...
sdoh_numeric <- sdoh_numeric[,-c(5, 6, 19, 26, 28)]  
dictionary <- dictionary[-c(5, 6, 19, 26, 28),]
names(sdoh_numeric)[102] <- "Gini.Index.Income.Inequal"
names(sdoh_numeric)[91] <- "American.Indian.Alaskan.Native.Alone"
names(sdoh_numeric)[92] <- "Asian.Alone"
names(sdoh_numeric)[93] <- "Black.or.African.America.Alone"
names(sdoh_numeric)[94] <- "Native.Hawiian.Other.Pacific.Islander.Alone"
names(sdoh_numeric)[95] <- "Some.Other.Race.Alone"
